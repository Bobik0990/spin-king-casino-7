...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-bc3bf5ed');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-bc3bf5ed');}
...
function clearFlash(){dieView.classList.remove('rl-win-bc3bf5ed');dieView.classList.remove('rl-lose-bc3bf5ed');if(frameEl){frameEl.classList.remove('rl-win-bc3bf5ed');frameEl.classList.remove('rl-lose-bc3bf5ed');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-bc3bf5ed');if(frameEl){frameEl.classList.add('rl-win-bc3bf5ed');}}else{dieView.classList.add('rl-lose-bc3bf5ed');if(frameEl){frameEl.classList.add('rl-lose-bc3bf5ed');}}
...
var brandEl=document.querySelector('.rl-brand-bc3bf5ed');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
